	...
	export default{
		...
		methods:{
			...
			valiCon(){
				...
				if(_.iteminfo.avgMoney == '' || _.iteminfo.avgMoney>199 ){
					_.vali.avgMoney = true;
				};
				if(_.iteminfo.owerRatio == '' || _.iteminfo.owerRatio>100 ){
				...
				if(_.iteminfo.avgMoney != '' && _.iteminfo.avgMoney<200 ){
					_.vali.avgMoney = false;
				};
				if(_.iteminfo.owerRatio != '' && _.iteminfo.owerRatio<101 ){
