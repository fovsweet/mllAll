<script>
	import store from '../vuex/festival/store.js';
	import {sharGetPrize,quiteDia,initData,getPrizeList,setList} from '../vuex/festival/actions';
...
<style lang="less">
	...
	.container{
		/*background:url('../assents/images/festival/newbg.jpg') center top no-repeat;*/
	...
	.river{
		width: 100%;
		height: 14.5rem;
		/* background:url('../assents/images/festival/river.png') center top no-repeat;
		background-size: 100% auto; */
		position: relative;
	}
	.boat{
		width: 3rem;
		height: 3.1rem;
		background: url('../assents/images/festival/boat.png') center center no-repeat;
	...
	.tips{
		width: 16rem;
		height: 2.875rem;
		background: url('../assents/images/festival/river-tips.png') center center no-repeat;
		background-size: 100% 100%;
		font-size: .55rem;
		color: white;
		line-height: 1.5;
	...
	.content{
		.tab-group{
			...
			text-align: center;
			 ...
			 .current{
				background: url('../assents/images/festival/tab-btn-hover.png') center center no-repeat;
				background-size: 100% 100%;
				color: white;
			}
		}
