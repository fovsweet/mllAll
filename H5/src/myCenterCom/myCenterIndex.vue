...
<div v-cloak>
	...
	<div class="link">
		<div class="phone"></div>
		<div class="adviser">联系您的专属顾问</div>
...
<style lang="less">
	...
	.container{
		...
		.arrow{
			width: .375rem;
			height: .6rem;
			background: url(../assents/images/arrow-right-white.png) center center no-repeat;
			background-size: 100% 100%;
	...
	.link{
		...
		.arrow{
			width: .375rem;
			height: .6rem;
			background: url(../assents/images/arrow-right-gray.png) center center no-repeat;
			background-size: 100% 100%;
			margin-right: .75rem;
			margin-left: .75rem;
		}
