		...
		<div class="modal-wrapper">
			<div class="modal-container">
				...
				<div class="modal-content">
					<slot name="body">123123123</slot>
				</div>
				<div class="modal-foot">
					<button type="button" class="btn-cancel" @click='storeShow()'>取&emsp;消</button>
					<button type="button" class="btn-save" @click='storeShow()'> 确&emsp;认</button>
				</div>
			</div>
		</div>
	</div>
