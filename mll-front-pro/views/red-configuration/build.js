...
/***/ function(module, exports, __webpack_require__) {
	...
	var _devtool = __webpack_require__(366);

	var _devtool2 = _interopRequireDefault(_devtool);

	var _override = __webpack_require__(367);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _middlewares = __webpack_require__(404);
	...
	var mutations = {
	  ...
	  TOGGLE_TODO: function TOGGLE_TODO(state, todo) {
	    todo.done = !todo.done;
	  },
	  EDIT_TODO: function EDIT_TODO(state, todo, text) {
	    todo.text = text;
	  },
	  TOGGLE_ALL: function TOGGLE_ALL(state, done) {
	    state.todos.forEach(function (todo) {
	      todo.done = done;
	    });
	  },
	  CLEAR_COMPLETED: function CLEAR_COMPLETED(state) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] examples\\todomvc\\components\\App.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../css-loader/index.js!./../vue-loader/lib/style-rewriter.js!./index.css", function() {
				var newContent = require("!!./../css-loader/index.js!./../vue-loader/lib/style-rewriter.js!./index.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Todo = __webpack_require__(409);
	...
	exports.default = {
	  ...
	  vuex: {
	    ...
	    actions: {
	      ...
	      clearCompleted: _actions.clearCompleted
	    }
	  },
	  data: function data() {
	    return {
	  ...
	  methods: {
	    tryAddTodo: function tryAddTodo(e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] examples\\todomvc\\components\\Todo.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports) {
	...
	var addTodo = exports.addTodo = makeAction('ADD_TODO');
	var deleteTodo = exports.deleteTodo = makeAction('DELETE_TODO');
	var toggleTodo = exports.toggleTodo = makeAction('TOGGLE_TODO');
	var editTodo = exports.editTodo = makeAction('EDIT_TODO');
	var toggleAll = exports.toggleAll = makeAction('TOGGLE_ALL');
	var clearCompleted = exports.clearCompleted = makeAction('CLEAR_COMPLETED');
